...
int main(void)
{
    ...
    window = glfwCreateWindow(640, 480, "Assignment2_Task4", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;
    ...
    cout << "******* Task4: View Control *******" << endl;
    cout << "Press key '+' to increase the zoom by 20% zooming in in the center of the screen, press key '-' to ecrease the zoom by 20% zooming out in the center of the screen, press key w’, ’a’, ’s’, and ’d’ to pan the view by 20% of the visible part of the scene, i.e. translate the entire scene, respectively down, right, up and left by 20% of the window size" << endl;
    colorCode <<
